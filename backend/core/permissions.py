...
class IsPremiumUser(BasePermission):
    def has_permission(self, request, view):
        return bool(request.user and request.user.is_authenticated and request.user.account_type == UserModel.AccountTypeChoices.PREMIUM)
...
class IsAdminRole(BasePermission):
    def has_permission(self, request, view):
        return bool(
            ...
            and request.user.role == UserModel.RoleChoices.ADMIN or request.user.is_superuser
        )
